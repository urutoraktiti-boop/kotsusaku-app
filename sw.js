...
// ============================================================
const CACHE_VERSION = 'kotsusaku-v124-seasondate-0921';
...
const CACHE_FILES = [
  ...
  './index.html',
  './manifest.json',
  './kotsusaku.css?v=kotsusaku-v124-seasondate-0921',    // index.html の読み込み先（?v=）と必ずそろえること
  './kotsu-tasks.css?v=kotsusaku-v124-seasondate-0921',   // index.html の読み込み先（?v=）と必ずそろえること
  './kotsu-tasks.js?v=kotsusaku-v124-seasondate-0921',    // 同上。ずれると保管した分が使われず、毎回ネットから取りに行く
